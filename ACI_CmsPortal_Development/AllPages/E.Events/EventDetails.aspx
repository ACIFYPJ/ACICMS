<%@ Page Title="" Language="C#" MasterPageFile="~/AllMasterPages/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="EventDetails.aspx.cs" Inherits="ACI_CmsPortal_Development.AllPages.E.Events.EventDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-sm-12">
            <h4>Total number of applicants for this event : 
    <asp:Label ID="lblTotalNumberOfApplicants" runat="server" Text=""></asp:Label></h4>
